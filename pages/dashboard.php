...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    ...
    <a href="?page=laporan-penerimaan"
        class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow cursor-pointer block">
    ...
    <div class="overflow-x-auto">
        <table class="w-full table-auto">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID Barang
                    </th>
                    ...
                    <?php foreach ($barang_stok_sedikit as $barang): ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap font-medium">
                                <?php echo htmlspecialchars($barang['nama_barang']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                <?php echo htmlspecialchars($barang['merek']); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <span
                                    class="<?php echo $barang['stok'] < 10 ? 'bg-red-600 text-white' : 'bg-red-100 text-red-700'; ?> font-bold py-1 px-3 rounded-full text-sm">
                                    <?php echo htmlspecialchars($barang['stok']); ?>
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span
                                    class="text-xs <?php echo $barang['stok'] < 10 ? 'text-red-600 font-bold' : 'text-orange-600'; ?>">
